...
class pluginclass(object):
    ...
    def __init__(self, deniosMenuWin, toggleButton, de):
        ...
        self.builder.add_from_file("/usr/share/linuxdenios/deniosmenu/system.ui")
        ...
        # Gconf stuff
        self.settings = Gio.Settings("com.linuxdenios.deniosmenu.plugins.system_management")
    ...
    def do_standard_items(self):
        ...
        if self.showSoftwareManager:
            if os.path.exists("/usr/bin/deniosinstall"):
                Button1 = easyButton("deniosinstall", self.iconsize, [_("Software Manager")], -1, -1)
                Button1.connect("clicked", self.ButtonClicked, "deniosinstall")
                Button1.show()
                self.systemBtnHolder.pack_start(Button1, False, False, 0)
                self.deniosMenuWin.setTooltip(Button1, _("Browse and install available software"))
        ...
        if self.showPackageManager:
            ...
            self.deniosMenuWin.setTooltip(Button2, _("Install, remove and upgrade software packages"))
        ...
        if self.showControlCenter:
            ...
            self.deniosMenuWin.setTooltip(Button3, _("Configure your system"))
        ...
        if self.showTerminal:
            ...
            self.deniosMenuWin.setTooltip(Button4, _("Use the command line"))
        ...
        if self.showLockScreen:
            ...
            self.deniosMenuWin.setTooltip(Button5, _("Requires password to unlock"))
        ...
        if self.showLogout:
            ...
            self.deniosMenuWin.setTooltip(Button6, _("Log out or switch user"))
        ...
        if self.showQuit:
            ...
            self.deniosMenuWin.setTooltip(Button7, _("Shutdown, restart, suspend or hibernate"))
