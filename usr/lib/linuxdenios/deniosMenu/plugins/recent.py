...
class pluginclass:
    ...
    def __init__(self, deniosMenuWin, toggleButton, de):
        ...
        self.Win = deniosMenuWin
        self.toggleButton = toggleButton
        self.de = de

        self.builder = Gtk.Builder()
        self.builder.set_translation_domain("deniosmenu")
        self.builder.add_from_file("/usr/share/linuxdenios/deniosmenu/recent.ui")
        ...
        self.settings = Gio.Settings("com.linuxdenios.deniosmenu.plugins.recent")
        RecentHelper.settings = self.settings

        self.migrate_recent_apps()
        self.settings.connect('changed', self.RegenPlugin)

        self.appSettings = Gio.Settings("com.linuxdenios.deniosmenu.plugins.applications")
    ...
    def migrate_recent_apps(self):
        ...
        path = os.path.join(home, ".linuxdenios/deniosMenu/recentApplications.list")
