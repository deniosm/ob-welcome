...
class pluginclass(object):
    ...
    def __init__(self, deniosMenuWin, toggleButton, de):
        ...
        builder.add_from_file("/usr/share/linuxdenios/deniosmenu/places.ui")
        ...
        # Settings
        self.settings = Gio.Settings("com.linuxdenios.deniosmenu.plugins.places")
    ...
    def do_standard_places(self):
        ...
        if self.showcomputer:
            ...
            self.deniosMenuWin.setTooltip(Button1, _("Browse all local and remote disks and folders accessible from this computer"))
        ...
        if self.showhomefolder:
            ...
            self.deniosMenuWin.setTooltip(Button2, _("Open your personal folder"))
        ...
        if self.shownetwork and self.de == "mate":
            ...
            self.deniosMenuWin.setTooltip(Button3, _("Browse bookmarked and local network locations"))
        ...
        if self.showdesktop:
            ...
            try:
                import sys
                sys.path.append('/usr/lib/linuxdenios/common')
            ...
            self.deniosMenuWin.setTooltip(Button4, _("Browse items placed on the desktop"))
        ...
        if self.showtrash:
            ...
            self.deniosMenuWin.setTooltip(self.trashButton, _("Browse deleted files"))
