...
# i18n
gettext.install("deniosmenu", "/usr/share/linuxdenios/locale")
locale.bindtextdomain("deniosmenu", "/usr/share/linuxdenios/locale")
locale.textdomain("deniosmenu")
...
class deniosMenuPreferences():

    def __init__(self):

        self.settings = Gio.Settings(schema_id="com.linuxdenios.deniosmenu")
        self.places_settings = Gio.Settings(schema_id="com.linuxdenios.deniosmenu.plugins.places")

        self.builder = Gtk.Builder()
        self.builder.set_translation_domain("deniosmenu")
        self.builder.add_from_file("/usr/share/linuxdenios/deniosmenu/preferences.ui")

        self.window = self.builder.get_object("main_window")
        self.window.set_title(_("Menu preferences"))
        self.window.set_icon_name("linuxdenios-logo")
        ...
        section.add_row(GSettingsSwitch(_("Show button icon"), "com.linuxdenios.deniosmenu", "show-applet-icon"))
        section.add_reveal_row(GSettingsEntry(_("Button text"), "com.linuxdenios.deniosmenu", "applet-text"), "com.linuxdenios.deniosmenu", "show-applet-icon")
        logos = {}
        logos['name']= _("Menu icons")
        logos['icons']= self.settings.get_strv("applet-icons")
        icon_chooser = GSettingsIconChooser(_("Button icon"), "com.linuxdenios.deniosmenu", "applet-icon", default_icon=self.settings.get_string("default-applet-icon"), icon_categories=[logos])
        icon_chooser.content_widget.set_default_category(_("Menu icons"))
        section.add_reveal_row(icon_chooser, "com.linuxdenios.deniosmenu", "show-applet-icon")
        ...
        section.add_row(GSettingsSwitch(_("Show tooltips"), "com.linuxdenios.deniosmenu", "tooltips-enabled"))
        ...
        section.add_row(GSettingsComboBox(_("Theme:"), "com.linuxdenios.deniosmenu", "theme-name", options))

        section = page.add_section(_("Icon sizes"), _("The size of the icons"))
        section.add_row(GSettingsSpinButton(_("Favorites"), "com.linuxdenios.deniosmenu.plugins.applications", "favicon-size", mini=1, maxi=128, step=1, page=2))
        section.add_row(GSettingsSpinButton(_("Applications"), "com.linuxdenios.deniosmenu.plugins.applications", "icon-size", mini=1, maxi=128, step=1, page=2))
        section.add_row(GSettingsSpinButton(_("System"), "com.linuxdenios.deniosmenu.plugins.system_management", "icon-size", mini=1, maxi=128, step=1, page=2))
        section.add_row(GSettingsSpinButton(_("Places"), "com.linuxdenios.deniosmenu.plugins.places", "icon-size", mini=1, maxi=128, step=1, page=2))

        page = SettingsPage()
        self.builder.get_object("box_applications").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSwitch(_("Show search bar on top"), "com.linuxdenios.deniosmenu.plugins.applications", "search-on-top"))
        section.add_row(GSettingsSwitch(_("Show applications comments"), "com.linuxdenios.deniosmenu.plugins.applications", "show-application-comments"))

        section = page.add_section(_("Categories"), _("Applications categories"))
        section.add_row(GSettingsSwitch(_("Show category icons"), "com.linuxdenios.deniosmenu.plugins.applications", "show-category-icons"))
        section.add_row(GSettingsSwitch(_("Switch categories on hover"), "com.linuxdenios.deniosmenu.plugins.applications", "categories-mouse-over"))
        section.add_reveal_row(GSettingsSpinButton(_("Hover delay"), "com.linuxdenios.deniosmenu.plugins.applications", "category-hover-delay", units=_("milliseconds"), mini=1, maxi=500, step=1, page=10), "com.linuxdenios.deniosmenu.plugins.applications", "categories-mouse-over")

        section = page.add_section(_("Search"), _("Search options"))
        section.add_row(GSettingsSwitch(_("Search for packages to install"), "com.linuxdenios.deniosmenu.plugins.applications", "use-apt"))
        section.add_row(GSettingsSwitch(_("Remember the last category or search"), "com.linuxdenios.deniosmenu.plugins.applications", "remember-filter"))
        section.add_row(GSettingsSwitch(_("Enable Internet search"), "com.linuxdenios.deniosmenu.plugins.applications", "enable-internet-search"))
        section.add_row(GSettingsEntry(_("Search command"), "com.linuxdenios.deniosmenu.plugins.applications", "search-command"))

        page = SettingsPage()
        self.builder.get_object("box_favorites").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSpinButton(_("Number of columns"), "com.linuxdenios.deniosmenu.plugins.applications", "fav-cols", mini=1, maxi=5, step=1, page=1))
        section.add_row(GSettingsSwitch(_("Swap name and generic name"), "com.linuxdenios.deniosmenu.plugins.applications", "swap-generic-name"))
        section.add_row(GSettingsSwitch(_("Show favorites when the menu is open"), "com.linuxdenios.deniosmenu", "start-with-favorites"))

        page = SettingsPage()
        self.builder.get_object("box_system").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSwitch(_("Custom height"), "com.linuxdenios.deniosmenu.plugins.system_management", "allow-scrollbar"))
        section.add_reveal_row(GSettingsSpinButton(_("Height"), "com.linuxdenios.deniosmenu.plugins.system_management", "height", mini=1, maxi=800, step=1, page=2), "com.linuxdenios.deniosmenu.plugins.system_management", "allow-scrollbar")

        section = page.add_section(_("Items"), _("Toggle default items"))
        section.add_row(GSettingsSwitch(_("Software Manager"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-software-manager"))
        section.add_row(GSettingsSwitch(_("Package Manager"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-package-manager"))
        section.add_row(GSettingsSwitch(_("Control Center"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-control-center"))
        section.add_row(GSettingsSwitch(_("Terminal"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-terminal"))
        section.add_row(GSettingsSwitch(_("Lock Screen"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-lock-screen"))
        section.add_row(GSettingsSwitch(_("Logout"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-logout"))
        section.add_row(GSettingsSwitch(_("Quit"), "com.linuxdenios.deniosmenu.plugins.system_management", "show-quit"))

        page = SettingsPage()
        self.builder.get_object("box_places").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSwitch(_("Custom height"), "com.linuxdenios.deniosmenu.plugins.places", "allow-scrollbar"))
        section.add_reveal_row(GSettingsSpinButton(_("Height"), "com.linuxdenios.deniosmenu.plugins.places", "height", mini=1, maxi=800, step=1, page=2), "com.linuxdenios.deniosmenu.plugins.places", "allow-scrollbar")

        section = page.add_section(_("Items"), _("Toggle default items"))
        section.add_row(GSettingsSwitch(_("Computer"), "com.linuxdenios.deniosmenu.plugins.places", "show-computer"))
        section.add_row(GSettingsSwitch(_("Home Folder"), "com.linuxdenios.deniosmenu.plugins.places", "show-home-folder"))
        section.add_row(GSettingsSwitch(_("Network"), "com.linuxdenios.deniosmenu.plugins.places", "show-network"))
        section.add_row(GSettingsSwitch(_("Desktop"), "com.linuxdenios.deniosmenu.plugins.places", "show-desktop"))
        section.add_row(GSettingsSwitch(_("Trash"), "com.linuxdenios.deniosmenu.plugins.places", "show-trash"))
        section.add_row(GSettingsSwitch(_("GTK Bookmarks"), "com.linuxdenios.deniosmenu.plugins.places", "show-gtk-bookmarks"))
...
if __name__ == "__main__":
    setproctitle.setproctitle('deniosmenu-preferences')
    preferences = deniosMenuPreferences()
    Gtk.main()
