...
class pluginclass(object):
    ...
    def __init__(self, deniosMenuWin, toggleButton, de):
        ...
        builder.add_from_file("/usr/share/osdenios/deniosmenu/places.ui")
        ...
        # Settings
        self.settings = Gio.Settings("com.osdenios.deniosmenu.plugins.places")
    ...
    def do_standard_places(self):
        ...
        if self.showdesktop:
            ...
            try:
                import sys
                sys.path.append('/usr/lib/osdenios/common')
