...
class pluginclass:
    ...
    def __init__(self, deniosMenuWin, toggleButton, de):
        ...
        self.builder.add_from_file("/usr/share/osdenios/deniosmenu/recent.ui")
        ...
        self.settings = Gio.Settings("com.osdenios.deniosmenu.plugins.recent")
        RecentHelper.settings = self.settings

        self.migrate_recent_apps()
        self.settings.connect('changed', self.RegenPlugin)

        self.appSettings = Gio.Settings("com.osdenios.deniosmenu.plugins.applications")
    ...
    def migrate_recent_apps(self):
        ...
        path = os.path.join(home, ".osdenios/deniosMenu/recentApplications.list")
