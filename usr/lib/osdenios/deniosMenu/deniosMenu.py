...
class MainWindow(object):
    ...
    def __init__(self, toggleButton, settings, de):
        ...
        builder.add_from_file("/usr/share/osdenios/deniosmenu/main.ui")
        ...
        plugindir = os.path.join(os.path.expanduser("~"), ".osdenios/deniosMenu/plugins")
...
class MenuWin(object):
    ...
    def __init__(self, applet, iid):
        ...
        self.settings = Gio.Settings.new("com.osdenios.deniosmenu")
    ...
    def updatePanelButton(self):
        ...
        if os.path.isfile("/etc/osdenios/info"):
            with open("/etc/osdenios/info") as info:
                for line in info:
    ...
    def showAboutDialog(self, action, userdata = None):
        ...
        # about.set_authors(["Clement Lefebvre <clem@osdenios.com>", "Lars-Peter Clausen <lars@laprican.de>"])
        about.set_translator_credits(("translator-credits"))
        # about.set_copyright(_("Based on USP from S.Chanderbally"))
        about.set_logo(GdkPixbuf.Pixbuf.new_from_file("/usr/lib/osdenios/deniosMenu/icon.svg"))
        about.connect("response", lambda dialog, r: dialog.destroy())
        about.show()

    def showPreferences(self, action, userdata = None):
        Execute("/usr/lib/osdenios/deniosMenu/preferences.py")
