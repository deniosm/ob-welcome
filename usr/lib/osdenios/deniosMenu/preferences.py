...
# i18n
gettext.install("deniosmenu", "/usr/share/osdenios/locale")
locale.bindtextdomain("deniosmenu", "/usr/share/osdenios/locale")
...
class deniosMenuPreferences():
    ...
    def __init__(self):
        ...
        self.settings = Gio.Settings(schema_id="com.osdenios.deniosmenu")
        self.places_settings = Gio.Settings(schema_id="com.osdenios.deniosmenu.plugins.places")

        self.builder = Gtk.Builder()
        self.builder.set_translation_domain("deniosmenu")
        self.builder.add_from_file("/usr/share/osdenios/deniosmenu/preferences.ui")

        self.window = self.builder.get_object("main_window")
        self.window.set_title(_("Menu preferences"))
        self.window.set_icon_name("osdenios-logo")
        ...
        section.add_row(GSettingsSwitch(_("Show button icon"), "com.osdenios.deniosmenu", "show-applet-icon"))
        section.add_reveal_row(GSettingsEntry(_("Button text"), "com.osdenios.deniosmenu", "applet-text"), "com.osdenios.deniosmenu", "show-applet-icon")
        logos = {}
        logos['name']= _("Menu icons")
        logos['icons']= self.settings.get_strv("applet-icons")
        icon_chooser = GSettingsIconChooser(_("Button icon"), "com.osdenios.deniosmenu", "applet-icon", default_icon=self.settings.get_string("default-applet-icon"), icon_categories=[logos])
        icon_chooser.content_widget.set_default_category(_("Menu icons"))
        section.add_reveal_row(icon_chooser, "com.osdenios.deniosmenu", "show-applet-icon")
        ...
        section.add_row(GSettingsSwitch(_("Show tooltips"), "com.osdenios.deniosmenu", "tooltips-enabled"))
        ...
        section.add_row(GSettingsComboBox(_("Theme:"), "com.osdenios.deniosmenu", "theme-name", options))

        section = page.add_section(_("Icon sizes"), _("The size of the icons"))
        section.add_row(GSettingsSpinButton(_("Favorites"), "com.osdenios.deniosmenu.plugins.applications", "favicon-size", mini=1, maxi=128, step=1, page=2))
        section.add_row(GSettingsSpinButton(_("Applications"), "com.osdenios.deniosmenu.plugins.applications", "icon-size", mini=1, maxi=128, step=1, page=2))
        section.add_row(GSettingsSpinButton(_("System"), "com.osdenios.deniosmenu.plugins.system_management", "icon-size", mini=1, maxi=128, step=1, page=2))
        section.add_row(GSettingsSpinButton(_("Places"), "com.osdenios.deniosmenu.plugins.places", "icon-size", mini=1, maxi=128, step=1, page=2))

        page = SettingsPage()
        self.builder.get_object("box_applications").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSwitch(_("Show search bar on top"), "com.osdenios.deniosmenu.plugins.applications", "search-on-top"))
        section.add_row(GSettingsSwitch(_("Show applications comments"), "com.osdenios.deniosmenu.plugins.applications", "show-application-comments"))

        section = page.add_section(_("Categories"), _("Applications categories"))
        section.add_row(GSettingsSwitch(_("Show category icons"), "com.osdenios.deniosmenu.plugins.applications", "show-category-icons"))
        section.add_row(GSettingsSwitch(_("Switch categories on hover"), "com.osdenios.deniosmenu.plugins.applications", "categories-mouse-over"))
        section.add_reveal_row(GSettingsSpinButton(_("Hover delay"), "com.osdenios.deniosmenu.plugins.applications", "category-hover-delay", units=_("milliseconds"), mini=1, maxi=500, step=1, page=10), "com.osdenios.deniosmenu.plugins.applications", "categories-mouse-over")

        section = page.add_section(_("Search"), _("Search options"))
        section.add_row(GSettingsSwitch(_("Search for packages to install"), "com.osdenios.deniosmenu.plugins.applications", "use-apt"))
        section.add_row(GSettingsSwitch(_("Remember the last category or search"), "com.osdenios.deniosmenu.plugins.applications", "remember-filter"))
        section.add_row(GSettingsSwitch(_("Enable Internet search"), "com.osdenios.deniosmenu.plugins.applications", "enable-internet-search"))
        section.add_row(GSettingsEntry(_("Search command"), "com.osdenios.deniosmenu.plugins.applications", "search-command"))

        page = SettingsPage()
        self.builder.get_object("box_favorites").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSpinButton(_("Number of columns"), "com.osdenios.deniosmenu.plugins.applications", "fav-cols", mini=1, maxi=5, step=1, page=1))
        section.add_row(GSettingsSwitch(_("Swap name and generic name"), "com.osdenios.deniosmenu.plugins.applications", "swap-generic-name"))
        section.add_row(GSettingsSwitch(_("Show favorites when the menu is open"), "com.osdenios.deniosmenu", "start-with-favorites"))

        page = SettingsPage()
        self.builder.get_object("box_system").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSwitch(_("Custom height"), "com.osdenios.deniosmenu.plugins.system_management", "allow-scrollbar"))
        section.add_reveal_row(GSettingsSpinButton(_("Height"), "com.osdenios.deniosmenu.plugins.system_management", "height", mini=1, maxi=800, step=1, page=2), "com.osdenios.deniosmenu.plugins.system_management", "allow-scrollbar")

        section = page.add_section(_("Items"), _("Toggle default items"))
        section.add_row(GSettingsSwitch(_("Software Manager"), "com.osdenios.deniosmenu.plugins.system_management", "show-software-manager"))
        section.add_row(GSettingsSwitch(_("Package Manager"), "com.osdenios.deniosmenu.plugins.system_management", "show-package-manager"))
        section.add_row(GSettingsSwitch(_("Control Center"), "com.osdenios.deniosmenu.plugins.system_management", "show-control-center"))
        section.add_row(GSettingsSwitch(_("Terminal"), "com.osdenios.deniosmenu.plugins.system_management", "show-terminal"))
        section.add_row(GSettingsSwitch(_("Lock Screen"), "com.osdenios.deniosmenu.plugins.system_management", "show-lock-screen"))
        section.add_row(GSettingsSwitch(_("Logout"), "com.osdenios.deniosmenu.plugins.system_management", "show-logout"))
        section.add_row(GSettingsSwitch(_("Quit"), "com.osdenios.deniosmenu.plugins.system_management", "show-quit"))

        page = SettingsPage()
        self.builder.get_object("box_places").add(page)

        section = page.add_section(_("Layout"), _("Section layout"))
        section.add_row(GSettingsSwitch(_("Custom height"), "com.osdenios.deniosmenu.plugins.places", "allow-scrollbar"))
        section.add_reveal_row(GSettingsSpinButton(_("Height"), "com.osdenios.deniosmenu.plugins.places", "height", mini=1, maxi=800, step=1, page=2), "com.osdenios.deniosmenu.plugins.places", "allow-scrollbar")

        section = page.add_section(_("Items"), _("Toggle default items"))
        section.add_row(GSettingsSwitch(_("Computer"), "com.osdenios.deniosmenu.plugins.places", "show-computer"))
        section.add_row(GSettingsSwitch(_("Home Folder"), "com.osdenios.deniosmenu.plugins.places", "show-home-folder"))
        section.add_row(GSettingsSwitch(_("Network"), "com.osdenios.deniosmenu.plugins.places", "show-network"))
        section.add_row(GSettingsSwitch(_("Desktop"), "com.osdenios.deniosmenu.plugins.places", "show-desktop"))
        section.add_row(GSettingsSwitch(_("Trash"), "com.osdenios.deniosmenu.plugins.places", "show-trash"))
        section.add_row(GSettingsSwitch(_("GTK Bookmarks"), "com.osdenios.deniosmenu.plugins.places", "show-gtk-bookmarks"))
